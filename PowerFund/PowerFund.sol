...
contract PowerToken is ERC20Interface {
    string public name = 'Powergo';
    string public symbol = 'PGO';
...
contract PowerFund is PowerToken {
    ...
    // token price in wei: 1PGO = 0.001 ETHER, 1 ETHER = 1000 PGO
    ...
    */
    ...
    // function getRequests() public view returns (memory) {
    //     Request storage thisRequests = requests;
    //     return thisRequests;
    // }
    
     function getRequests() public view returns (Request[] memory) {
      Request[]  memory id = new Request[](noOfRequests);
